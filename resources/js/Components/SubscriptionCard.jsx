...
export default function SubscriptionCard({id,name,price,isPremium,durationInMonth,onSelectSubscription,features, }) {
    return <>
                {/* <!-- Start Basic --> */}
            {!isPremium && (
                    <div
                        ...
                        {/* <!-- Bottom: CTA Button --> */}
                        <div>
                   <PrimaryButton onClick={onSelectSubscription} type="button" variant="white-outline">
            ...
            {isPremium && (
                    ...
                    <div
                        ...
                        <div onClick={onSelectSubscription}>
                            <PrimaryButton variant="primary" type="button">
